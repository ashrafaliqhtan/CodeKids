...
if(isset($_REQUEST['requpdate'])){
    ...
    if(empty($_REQUEST['stu_id']) || empty($_REQUEST['stu_name']) || 
       empty($_REQUEST['stu_email']) || empty($_REQUEST['stu_pass']) || 
       empty($_REQUEST['stu_occ'])){
        
        $msg = '<div class="alert alert-warning">All fields are required.</div>';
    } else {
        // Sanitize inputs
        $stu_id = (int)$_REQUEST['stu_id'];
        ...
        if(empty($msg)){
            ...
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sssssi", $stu_name, $stu_email, $stu_pass, $stu_occ, $stu_img, $stu_id);
...
<head>
    ...
    <title>CodeKids | Update Student</title>
    <!-- Font Awesome -->
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="stu_id"
                            name="stu_id"
                            value="<?php echo isset($row['stu_id']) ? htmlspecialchars($row['stu_id']) : ''; ?>"
                            readonly
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="stu_name"
                            name="stu_name"
                            value="<?php echo isset($row['stu_name']) ? htmlspecialchars($row['stu_name']) : ''; ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="stu_email"
                            name="stu_email"
                            value="<?php echo isset($row['stu_email']) ? htmlspecialchars($row['stu_email']) : ''; ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="stu_occ"
                            name="stu_occ"
                            value="<?php echo isset($row['stu_occ']) ? htmlspecialchars($row['stu_occ']) : ''; ?>"
                            required
                        >
                    </div>
                    
                    <!-- Current Image Preview -->
                    <?php if(isset($row['stu_img']) && !empty($row['stu_img'])): ?>
                    <div class="form-group">
                        <label class="form-display">Current Image</label>
                        <div class="image-preview">
                            <img src="<?php echo htmlspecialchars($row['stu_img']); ?>" alt="Student Image">
                        </div>
                    </div>
                    <?php endif; ?>
                    
                    <div class="form-group">
                        <label class="form-display" for="stu_img">Update Image (Optional)</label>
                        <input
                            type="file"
