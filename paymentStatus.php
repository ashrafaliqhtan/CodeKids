...
<html lang="en">
  <head>
    ...
    <title>paymentStatus || CodeKids | Let's Crack the Code</title>
  </head>
  <body>
    <nav>
...
We are dedicated to supporting your learning journey and ensuring a seamless e-learning experience. Our team of experts is here to assist you every step of the way. Whether you need assistance with course selection, technical support, or general inquiries, we are just a click away.
          ...
          <ul class="contact_details">
            <li>
              ...
              <h5>+966 5123 456 789</h5>
            </li>
            <li>
              <i class="uil uil-envelope-alt"></i>
              <h5>support@CodeKids.com</h5>
            </li>
            <li>
    ...
    <footer>
      <div class="container footer_container">
        <div class="footer_1">
          ...
          <p>
            "Welcome to CodeKids, your one-stop destination for all things
      ...
      <div class="footer_copyright">
        <small
          >Copyright &copy; CodeKids || <a href="#">Admin_Login</a></small
        >
      </div>
    </footer>
    <!-- ==============================End of Footer====================================== -->
